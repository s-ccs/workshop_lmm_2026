...
::: {.callout-note}
Please note that we will not have dedicated time to be able to help with installing Julia and/or Pluto during the workshop. If you experience problems please contact us *before* the workshop. 
:::

In this video (recorded for a similar workshop with identical instructions), Romy shows how she installed everything using the steps below.
...
❌ Something didn't work? [Try following the instructions here](https://github.com/JuliaLang/juliaup). You can also send as an e-mail and we will help you.
...
https://github.com/s-ccs/workshop_lmm_2026/blob/main/00_installation.jl
```
